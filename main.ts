...
let maxTemp = 0
let temp = 0
datalogger.setColumnTitles("temperatura", "luminosidade", "indice_uv")
...
basic.forever(function on_forever() {
    ...
    basic.pause(5000)
    if (registar == 1) {
        datalogger.log(datalogger.createCV("temperatura", temp), datalogger.createCV("indice_uv", indiceUV), datalogger.createCV("luminosidade", luz))
        registar = 0
    }
